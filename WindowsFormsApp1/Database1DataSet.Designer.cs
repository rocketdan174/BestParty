...
namespace WindowsFormsApp1 {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public TableRow AddTableRow(string Имя, string Фамилия, string Отчество, System.DateTime Дата_рождения, string Адрес) {
...
namespace WindowsFormsApp1.Database1DataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Table] WHERE (([Id] = @Original_Id) AND ((@IsNull_Имя = 1 AND [Имя] IS NULL) OR ([Имя] = @Original_Имя)) AND ((@IsNull_Фамилия = 1 AND [Фамилия] IS NULL) OR ([Фамилия] = @Original_Фамилия)) AND ((@IsNull_Отчество = 1 AND [Отчество] IS NULL) OR ([Отчество] = @Original_Отчество)) AND ((@IsNull_Дата_рождения = 1 AND [Дата рождения] IS NULL) OR ([Дата рождения] = @Original_Дата_рождения)) AND ((@IsNull_Адрес = 1 AND [Адрес] IS NULL) OR ([Адрес] = @Original_Адрес)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([Имя], [Фамилия], [Отчество], [Дата рождения], [Адрес]" +
                ") VALUES (@Имя, @Фамилия, @Отчество, @Дата_рождения, @Адрес);\r\nSELECT Id, Имя, Ф" +
                "амилия, Отчество, [Дата рождения], Адрес FROM [Table] WHERE (Id = SCOPE_IDENTITY" +
                "())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [Имя] = @Имя, [Фамилия] = @Фамилия, [Отчество] = @Отчество, [Дата рождения] = @Дата_рождения, [Адрес] = @Адрес WHERE (([Id] = @Original_Id) AND ((@IsNull_Имя = 1 AND [Имя] IS NULL) OR ([Имя] = @Original_Имя)) AND ((@IsNull_Фамилия = 1 AND [Фамилия] IS NULL) OR ([Фамилия] = @Original_Фамилия)) AND ((@IsNull_Отчество = 1 AND [Отчество] IS NULL) OR ([Отчество] = @Original_Отчество)) AND ((@IsNull_Дата_рождения = 1 AND [Дата рождения] IS NULL) OR ([Дата рождения] = @Original_Дата_рождения)) AND ((@IsNull_Адрес = 1 AND [Адрес] IS NULL) OR ([Адрес] = @Original_Адрес)));
SELECT Id, Имя, Фамилия, Отчество, [Дата рождения], Адрес FROM [Table] WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Имя, Фамилия, Отчество, [Дата рождения], Адрес FROM dbo.[Table]";
        ...
        public virtual int Delete(int Original_Id, string Original_Имя, string Original_Фамилия, string Original_Отчество, global::System.Nullable<global::System.DateTime> Original_Дата_рождения, string Original_Адрес) {
        ...
        public virtual int Insert(string Имя, string Фамилия, string Отчество, global::System.Nullable<global::System.DateTime> Дата_рождения, string Адрес) {
            if ((Имя == null)) {
        ...
        public virtual int Update(string Имя, string Фамилия, string Отчество, global::System.Nullable<global::System.DateTime> Дата_рождения, string Адрес, int Original_Id, string Original_Имя, string Original_Фамилия, string Original_Отчество, global::System.Nullable<global::System.DateTime> Original_Дата_рождения, string Original_Адрес, int Id) {
            if ((Имя == null)) {
        ...
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Имя, string Фамилия, string Отчество, global::System.Nullable<global::System.DateTime> Дата_рождения, string Адрес, int Original_Id, string Original_Имя, string Original_Фамилия, string Original_Отчество, global::System.Nullable<global::System.DateTime> Original_Дата_рождения, string Original_Адрес) {
            return this.Update(Имя, Фамилия, Отчество, Дата_рождения, Адрес, Original_Id, Original_Имя, Original_Фамилия, Original_Отчество, Original_Дата_рождения, Original_Адрес, Original_Id);
        }
    }
